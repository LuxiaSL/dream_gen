...
> **Note**: For complete project vision and architecture, see [DREAM_WINDOW_MASTER.md](DREAM_WINDOW_MASTER.md)
...
The system uses atomic write operations to prevent file corruption when Rainmeter is reading:
...
The display system uses a multi-buffer approach:
...
This ensures smooth transitions without flicker or corruption.
...
This document covers file organization. For other topics:
...
- **Visual Design**: [AESTHETIC_SPEC.md](AESTHETIC_SPEC.md)
- **Command Reference**: [QUICK_REFERENCE.md](QUICK_REFERENCE.md)
- **Troubleshooting**: [TROUBLESHOOTING.md](TROUBLESHOOTING.md)

**Return to**: [README.md](README.md) for complete documentation navigation
